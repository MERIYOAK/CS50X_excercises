-- start by lokin for a crime scene report that matches the date and location of the crime
SELECT description FROM crime_scene_reports
WHERE year = 2021 AND month = 7 AND day = 28;
--get the interview transcripts mentions the bakery
SELECT transcript FROM interviews
WHERE year = 2021 AND month = 7 AND day = 28
AND transcript LIKE '%bakery%';
--then look for the car that left the aprkin lot in that time frame
...
--based on the witness testimony look to to the atm transactions also
